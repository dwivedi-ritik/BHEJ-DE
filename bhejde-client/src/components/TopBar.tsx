...
export default function TopBar() {
    return (
        <div className='bg-gray-800 w-100 h-12'>
            <div className='w-100 mx-auto py-2 flex justify-between items-center px-6'>
                <div className='flex gap-2 items-center'>
                    <p className='text-lg text-gray-100 font-bold'>BHEJ DE</p>
